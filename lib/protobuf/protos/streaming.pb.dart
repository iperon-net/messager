...
class StreamingEventsResponse extends $pb.GeneratedMessage {
  ...
  factory StreamingEventsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory StreamingEventsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamingEventsResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'Api'), createEmptyInstance: create)
    ..e<StreamingEventsResponse_Type>(1, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE,
        defaultOrMaker: StreamingEventsResponse_Type.healthcheck,
        valueOf: StreamingEventsResponse_Type.valueOf,
        enumValues: StreamingEventsResponse_Type.values)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  StreamingEventsResponse copyWith(void Function(StreamingEventsResponse) updates) =>
      super.copyWith((message) => updates(message as StreamingEventsResponse)) as StreamingEventsResponse;
  ...
  @$pb.TagNumber(1)
  set type(StreamingEventsResponse_Type v) {
    setField(1, v);
  }
