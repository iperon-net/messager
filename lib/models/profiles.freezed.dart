...
mixin _$Profile {
  ...
  TResult when<TResult extends Object?>(
    TResult Function(@JsonKey(name: 'first_name') String firstName, @JsonKey(name: 'last_name') String lastName,
            @JsonKey(name: 'about') String about, @JsonKey(name: 'date_birth') DateTime? dateBirth)
        $default,
  ) =>
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.dateBirth, dateBirth) || other.dateBirth == dateBirth));
  }
...
abstract class _Profile extends Profile {
  const factory _Profile(
      ...
      @JsonKey(name: 'date_birth') final DateTime? dateBirth}) = _$ProfileImpl;
